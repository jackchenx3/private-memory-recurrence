"""058 production allocation only; reuse accepted failure-propagating memory guard."""
...
def main():
 ...
 save('COMPLETION.json',dict(status='COMPLETE_PENDING_ACCOUNTING',job_id=os.environ['SLURM_JOB_ID'],elapsed_seconds=time.time()-start,source_sha256=sha(P/'SOURCE_SHA256SUMS'),result_sha256=sha(P/'RESULT_SHA256SUMS'),validation='PASS',new_paths=4608,reused_paths=0,total_scientific_paths=5760,intervals=114))
