...
fig.suptitle('Independent cohort: historical, fresh and sham probes; all paths retained');finish(fig,'01_trajectories')
keys=['RARE|RECUR_MINUS_IID|ACTIVE_C0-NOVEL_C0|D40','RARE|RECUR|ACTIVE_C0-NOVEL_C0|D40','RARE|IID|ACTIVE_C0-NOVEL_C0|D40','RARE|RECUR|ACTIVE_C0|D40','RARE|RECUR|ACTIVE_C0-SHAM_C0|D40','RARE|RECUR|ACTIVE_C1|D40','RARE|RECUR|ACTIVE_C1-NOVEL_C1|D40'];fig,ax=plt.subplots(figsize=(16,7),constrained_layout=True)
for i,k in enumerate(keys):point(ax,k,i)
ax.set_yticks(range(len(keys)),keys);ax.axvline(0,color='.6');ax.set_xlabel('Carrier change or retrieval contrast');ax.set_title('Frozen reversal prediction and companions; approximate pointwise intervals');finish(fig,'02_primary')
