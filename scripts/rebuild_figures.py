...
# Add the fixed one-update pulse using saved estimates only.
subprocess.run([sys.executable,str(ROOT/"scripts/rebuild_059_figure.py"),"--output-dir",str(OUT)],check=True)
