...
def inline(text,source):
    ...
    def link(match):
        ...
        if not url.startswith(('https://','http://')):
            ...
            url='https://github.com/jackchenx3/private-memory-recurrence/blob/v1.5.0/'+relative.as_posix()
...
def footer(canvas,doc):
    ...
    canvas.drawString(50,25,'Private memory and recurrence | Research preprint v1.5.0')
